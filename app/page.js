  ...
  return (
    <main>
      <nav className="flex justify-between items-center px-8 py-4 bg-white shadow-sm">
        <span className="text-2xl font-bold tracking-tight">Maria's Art ✦</span>
      ...
      <section className="flex flex-col items-center justify-center text-center py-32 px-4 bg-rose-50">
        ...
        <p className="text-lg text-gray-500 mb-8">Original paintings, prints & commissions by Maria</p>
